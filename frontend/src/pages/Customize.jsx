...
function Customize() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center  flex-col p-[20] ' >
      ...
      {selectedImage &&   <button className='min-w-[150px]  h-[60px] mt-[30px] bg-white rounded-full text-black font-semibold cursor-pointer text-[19px] rounded-full' onClick={()=>navigate("/customize2")} >Next</button> }
